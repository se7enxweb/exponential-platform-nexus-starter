 ...
 *                 embed?: array{ // RichText embed tags configuration.
 ...
 *             }>,
 *         },
 *         ng_content_view?: array<string, array<string, array{ // Default: []
 *                 extends?: scalar|Param|null, // Extended view type/name, for example full/article
 *                 template?: scalar|Param|null, // Your template path, as @App/my_template.html.twig
 *                 controller?: scalar|Param|null, // Use custom controller instead of the default one to display a content matching your rules. You can use the controller reference notation supported by Symfony.
 *                 redirect?: array{
 *                     target?: scalar|Param|null,
 *                     permanent?: scalar|Param|null, // Default: false
 *                     keep_request_method?: scalar|Param|null, // Default: false
 *                     absolute?: scalar|Param|null, // Default: false
 *                     target_parameters?: array<string, mixed>,
 *                 },
 *                 permanent_redirect?: scalar|Param|null, // Set up permanent redirect. You can use the expression language here as well.
 *                 temporary_redirect?: scalar|Param|null, // Set up temporary redirect. You can use the expression language here as well.
 *                 match?: array<string, mixed>,
 *                 queries?: array<string, string|array{ // Default: ["NG_DEFAULT_QUERIES_VALUE"]
 *                     query_type?: scalar|Param|null, // Name of the QueryType implementation
 *                     use_filter?: scalar|Param|null, // Whether to use FilterService of FindService
 *                     max_per_page?: scalar|Param|null, // Number of results per page when using pager
 *                     page?: scalar|Param|null, // Current page when using pager
 *                     parameters?: array<string, mixed>,
 *                     named_query?: scalar|Param|null, // Name of the configured query
 *                 }>,
 *                 params?: array<string, mixed>,
 *             }>>,
 *         ng_site_api?: array{ // Site API configuration
 *             site_api_is_primary_content_view?: bool|Param, // Controls whether Site API content view should be used as the primary content view
 *             fallback_to_secondary_content_view?: bool|Param, // Controls fallback content view rendering between primary and secondary content view (Site API or Ibexa CMS)
 *             fallback_without_subrequest?: bool|Param, // Controls whether secondary content view fallback should use a subrequest
 *             richtext_embed_without_subrequest?: bool|Param, // Controls whether RichText embed rendering should use a subrequest
 *             use_always_available_fallback?: bool|Param, // Controls missing translation fallback to main language marked as always available
 *             show_hidden_items?: bool|Param, // Controls whether hidden Locations and Content items will be shown by default
 *             fail_on_missing_field?: bool|Param, // Controls failing on a missing Content Field
 *             render_missing_field_info?: bool|Param, // Controls rendering useful debug information in place of a missing field
 *             enable_internal_view_route?: bool|Param, // Controls whether internal Content view route will work (applies for a frontend siteaccess only)
 *             redirect_internal_view_route_to_url_alias?: bool|Param, // Controls whether internal Content view route will redirect to URL alias route
 *             cross_siteaccess_content?: array{ // Cross-siteaccess Content configuration
 *                 enabled?: bool|Param, // Controls whether cross-siteaccess Content will be enabled
 *                 external_subtree_roots?: list<int|Param>,
 *                 included_siteaccesses?: list<scalar|Param|null>,
 *                 included_siteaccess_groups?: list<scalar|Param|null>,
 *                 excluded_siteaccesses?: list<scalar|Param|null>,
 *                 excluded_siteaccess_groups?: list<scalar|Param|null>,
 *                 prefer_main_language?: bool|Param, // Controls whether the main language should be preferred
 *             },
 *             named_objects?: array{ // Named objects configuration
 *                 content?: array<string, scalar|Param|null>,
 *                 locations?: array<string, scalar|Param|null>,
 *                 tags?: array<string, scalar|Param|null>,
 *             },
 *             named_queries?: array<string, array{ // Default: []
 *                 query_type?: scalar|Param|null, // Name of the QueryType implementation
 *                 use_filter?: scalar|Param|null, // Whether to use FilterService of FindService // Default: true
 *                 max_per_page?: scalar|Param|null, // Number of results per page when using pager // Default: 25
 *                 page?: scalar|Param|null, // Current page when using pager // Default: 1
 *                 parameters?: array<string, mixed>,
 *             }>,
 *         },
 *     }>,
 ...
 *     },
 * }
 * @psalm-type EzCoreExtraConfig = array{
 *     system?: array<string, array{ // Default: []
 *         twig_globals?: array<string, mixed>,
 *     }>,
 * }
 ...
 *                 }>>>,
 *         design?: string|Param, // Default: "standard"
 *         ibexa_component?: array{
 *             default_parent_location?: int|Param, // Default: 2
 *             parent_locations?: list<scalar|Param|null>,
 *         },
 *     }>,
 * }
 * @psalm-type NetgenLayoutsIbexaSiteApiConfig = array{
 *     search_service_adapter?: null|"filter"|"find"|Param, // Default: null
 * }
 * @psalm-type NetgenOpenGraphConfig = array{
 *     system?: array<string, array{ // Default: []
 *         content_type_handlers?: array<string, list<array{ // Default: []
 *                 handler?: scalar|Param|null,
 *                 tag?: scalar|Param|null,
 *                 params?: list<mixed>,
 *             }>>,
 *         global_handlers?: list<array{ // Default: []
 *             handler?: scalar|Param|null,
 *             tag?: scalar|Param|null,
 *             params?: list<mixed>,
 *         }>,
 *     }>,
 * }
 * @psalm-type NetgenTagsConfig = array{
 *     system?: array<string, array{ // Default: []
 *         tag_view?: array{
 *             cache?: bool|Param, // Whether to use tag view page cache or not (Last-Modified based) // Default: true
 *             ttl_cache?: bool|Param, // Whether to use TTL cache for tag view page (i.e. Max-Age response header) // Default: true
 *             default_ttl?: int|Param, // Default TTL cache value for tag view page // Default: 60
 *             template?: scalar|Param|null, // Default template used to generate tag view page // Default: "@NetgenTags/tag/view.html.twig"
 *             path_prefix?: scalar|Param|null, // Default path prefix to use when generating tag view links // Default: "/tags/view"
 *             related_content_list?: array{
 *                 limit?: int|Param, // Number of related content displayed per page in the tag view // Default: 10
 *                 return_content_info?: bool|Param, // Setting to control if ContentInfo objects will be returned instead of Content // Default: true
 *             },
 *         },
 *         tag_view_match?: array<string, array<string, array{ // Default: []
 *                 template?: scalar|Param|null, // Your template path, as @My/subdir/my_template.html.twig
 *                 controller?: scalar|Param|null, // Use custom controller instead of the default one to display a tag matching your rules. You can use the controller reference notation supported by Symfony.
 *                 match?: array<string, mixed>,
 *                 params?: array<string, mixed>,
 *             }>>,
 *         edit_views?: array<string, array{ // Default: []
 *             identifier?: scalar|Param|null,
 *             name?: scalar|Param|null,
 *             template?: scalar|Param|null, // Default: null
 *         }>,
 *         admin?: array{
 *             pagelayout?: scalar|Param|null, // Default pagelayout template for admin interface // Default: "@NetgenTags/admin/pagelayout.html.twig"
 *             children_limit?: int|Param, // Limit to tag children list in admin interface // Default: 25
 *             search_limit?: int|Param, // Limit to tag search result list in admin interface // Default: 25
 *             tree_limit?: int|Param, // Limit to tag tree children in admin interface // Default: 0
 *             related_content_limit?: int|Param, // Limit to tag related content list in admin interface // Default: 25
 *         },
 *         field?: array{
 *             autocomplete_limit?: int|Param, // Limit to autocomplete list in field edit interface // Default: 25
 *         },
 *     }>,
 * }
 * @psalm-type NgsiteConfig = array{
 *     system?: array<string, array{ // Default: []
 *         showcase?: array{
 *             rule_priority?: int|Param, // Default: 0
 *             rule_group_uuid?: scalar|Param|null, // Default: "00000000-0000-0000-0000-000000000000"
 *             blocks?: array<string, array{ // Default: []
 *                 title?: scalar|Param|null,
 *                 block_definition?: scalar|Param|null,
 *                 view_type?: scalar|Param|null,
 *                 parameters?: array<string, scalar|Param|null>,
 *                 item_view_types?: array<string, scalar|Param|null>,
 *                 variable_parameters?: array<string, scalar|Param|null>,
 *                 use_view_content_types?: bool|Param, // Default: true
 *                 excluded_content_types?: array<string, scalar|Param|null>,
 *                 included_content_types?: array<string, scalar|Param|null>,
 *             }>,
 *         },
 *     }>,
 * }
 * @psalm-type NetgenInformationCollectionConfig = array{
 *     system?: array<string, array{ // Default: []
 *         captcha?: array{
 *             enabled?: bool|Param, // Default: false
 *             override_by_type?: list<array{ // Default: []
 *                 enabled?: bool|Param, // Default: false
 *                 secret?: scalar|Param|null,
 *                 site_key?: scalar|Param|null,
 *                 options?: array{
 *                     action?: scalar|Param|null, // This only available in Captcha V3
 *                     type?: "invisible"|"checkbox"|Param, // Default: "checkbox"
 *                     theme?: "dark"|"light"|Param, // Default: "light"
 *                     size?: "normal"|"compact"|Param, // It is only taken into account if you are using the V2 with checkbox option // Default: "normal"
 *                 },
 *             }>,
 *             secret?: scalar|Param|null,
 *             site_key?: scalar|Param|null,
 ...
 *             content_types?: list<list<scalar|Param|null>>,
 *         },
 *         action_config?: array{
 ...
 *                     sender?: scalar|Param|null,
 *                     subject?: scalar|Param|null,
 *                     email_field_identifier?: scalar|Param|null, // Default: "email"
 *                 },
 *             },
 *             email?: array{
 *                 templates?: array{
 ...
 *                 newline?: scalar|Param|null, // Default: "\r\n"
 *                 enclosure?: scalar|Param|null, // Default: "\""
 *             },
 *         },
 *     }>,
 * }
 * @psalm-type NetgenIbexaSearchExtraConfig = array{
 *     indexable_field_type?: array{ // Configure override for field type Indexable interface implementation
 *         ibexa_richtext?: bool|array{
 *             enabled?: bool|Param, // Default: true
 *             short_text_limit?: int|Param, // Maximum number of characters for the indexed short text ('value' string type field) // Default: 256
 *         },
 *     },
 *     use_loading_search_result_extractor?: bool|Param, // Get search result objects by loading them from the persistence layer, instead of reconstructing them from the returned Solr data // Default: true
 *     use_asynchronous_indexing?: bool|Param, // Use asynchronous mechanism to handle repository content indexing // Default: false
 *     fulltext?: array{ // Fulltext configuration
 *         boost?: array<string, array{ // Default: []
 *             content_types?: array<string, float|Param>,
 *             raw_fields?: array<string, float|Param>,
 *             meta_fields?: array<string, float|Param>,
 *         }>,
 *         meta_fields?: array<string, list<scalar|Param|null>>,
 *     },
 *     use_page_indexing?: bool|Param, // Use layouts page text indexing // Default: false
 *     page_indexing?: array{ // Page indexing configuration
 *         enabled?: bool|Param, // Use page indexing // Default: false
 *         sites?: array<string, array{ // Default: []
 *             tree_root_location_id?: int|Param, // Site root Location ID
 *             language_siteaccess_map?: array<string, scalar|Param|null>,
 *             fields?: list<array<string, scalar|Param|null>>,
 *             allowed_content_types?: array<string, scalar|Param|null>,
 *             host?: scalar|Param|null, // Host to index the page from (optional, overrides the host defined for the siteaccess) // Default: null
 *         }>,
 *     },
 * }
 * @psalm-type NetgenIbexaAdminUiExtraConfig = array{
 *     show_siteaccess_urls_outside_configured_content_tree_root?: bool|Param, // Show Siteaccess URLs outside the configured Content tree root in administration's URL tab // Default: false
 *     queues?: bool|array{ // Configure Queues module in administration
 *         enabled?: bool|Param, // Enable the Queues module // Default: true
 *         transports?: list<scalar|Param|null>,
 *     },
 * }
 * @psalm-type NetgenToolbarConfig = array{
 *     default_admin_site_access?: scalar|Param|null, // Default: "%ngsite.admin_siteaccess_name%"
 *     legacy_admin_site_access?: scalar|Param|null, // Default: "ngadminui"
 *     admin_site_access_mapping?: list<scalar|Param|null>,
 * }
 * @psalm-type NetgenIbexaScheduledVisibilityConfig = bool|array{
 *     enabled?: bool|Param, // Default: false
 *     handler?: scalar|Param|null, // Configure handler for scheduled visibility mechanism // Default: "content"
 *     content_types?: bool|array{ // Configure content_types used for scheduled visibility mechanism
 *         all?: bool|Param, // Default: false
 *         allowed?: list<scalar|Param|null>,
 *     },
 *     sections?: array{ // Configure sections used for scheduled visibility mechanism
 *         visible?: array{ // Configure visible section id used for scheduled visibility mechanism
 *             section_id?: int|Param, // Default: 0
 *         },
 *         hidden?: array{ // Configure hidden section id used for scheduled visibility mechanism
 *             section_id?: int|Param, // Default: 0
 *         },
 *     },
 *     object_states?: array{ // Configure object_states used for scheduled visibility mechanism
 *         object_state_group_id?: int|Param, // Default: 0
 *         visible?: array{ // Configure visible object states and groups used for scheduled visibility mechanism
 *             object_state_id?: int|Param, // Default: 0
 *         },
 *         hidden?: array{ // Configure hidden object states and groups used for scheduled visibility mechanism
 *             object_state_id?: int|Param, // Default: 0
 *         },
 *     },
 * }
 ...
 *     ez_core_extra?: EzCoreExtraConfig,
 *     sentry?: SentryConfig,
 *     netgen_content_browser?: NetgenContentBrowserConfig,
 *     netgen_layouts?: NetgenLayoutsConfig,
 *     netgen_layouts_ibexa_site_api?: NetgenLayoutsIbexaSiteApiConfig,
 *     netgen_open_graph?: NetgenOpenGraphConfig,
 *     netgen_tags?: NetgenTagsConfig,
 *     ngsite?: NgsiteConfig,
 *     netgen_information_collection?: NetgenInformationCollectionConfig,
 *     netgen_ibexa_search_extra?: NetgenIbexaSearchExtraConfig,
 *     netgen_ibexa_admin_ui_extra?: NetgenIbexaAdminUiExtraConfig,
 *     netgen_toolbar?: NetgenToolbarConfig,
 *     netgen_ibexa_scheduled_visibility?: NetgenIbexaScheduledVisibilityConfig,
